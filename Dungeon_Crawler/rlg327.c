...
int main(int argc, char *argv[])
{
 ...
 if (argc > 1) {
  ...
  /*
   * Handle ncurses inits
   */
  initscr(); // init the window 
  raw(); // take one char at a time
  noecho(); // supress echo of typed chars
  keypad(stdscr, TRUE); // allow special keys (for arrow keys) 
